...
Every time code is pushed to the repository, the project is automatically built to ensure it works correctly.
...
- QuizActivity → Quiz logic  
- ResultActivity → Results and review  
